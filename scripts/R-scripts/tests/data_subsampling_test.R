...
#                  No sites dropped, no years dropped
...
#                  2/4 sites dropped, no years dropped
...
#            and vice versa
# Expected output: w = 2, z = 6 because temporal subsampling is prioritized over spatial,
#                  2/4 sites dropped, no years dropped
...
#                  3/8 sites dropped, no years dropped
...
#                  no sites dropped because the level of sampling needed
#                  to include the majority (> 50%) of sites actually 
#                  includes all sites.
...
# Expected output: w = 2, z = 4
#                  6 years dropped, site 2 dropped
...
wShouldBe = c(4, 6, 2, 6, 2, 2, 2, 2)
zShouldBe = c(4, 4, 6, 2, 2, 4, 4, 6)
numSitesShouldBe = c(4, 2, 2, 5, 4, 1, 1, 5)
numYearsShouldBe = c(10, 10, 10, 10, 10, 12, 12, 10)
