#from the Weecology lab github BBS forecasting repo 
...
##################################################
get_gimms_download_list=function(gimms_folder = '//bioark.ad.unc.edu/HurlbertLab/GIS/gimms/'){
...
process_gimms_ndvi_bbs=function(gimms_folder = '//bioark.ad.unc.edu/HurlbertLab/GIS/gimms/'){
...
get_bbs_gimms_ndvi = function(gimms_folder = '//bioark.ad.unc.edu/HurlbertLab/GIS/gimms/'){
