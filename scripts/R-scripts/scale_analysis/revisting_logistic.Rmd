...
Previous biggest issues were getting the function to work at all and trying to describe transients. Since I'm focusing on core species, I don't have to worry about trying to describe the transients here anymore, perhaps making for better outcomes. 
...
plot(meanOcc~logN, data = bbs_allscales, xlab = "Log Abundance" , ylab = "Mean Temporal Occupancy")
