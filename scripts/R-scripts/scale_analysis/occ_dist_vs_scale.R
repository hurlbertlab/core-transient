...
#reset wd to BioArk for large file storage

bbs_scalesorted<-write.csv(bbs_scalesorted, file="bbs_scalesorted.csv")
bbs_scalesorted<-read.csv("bbs_scalesorted.csv", header = T)
...
#setwd to folder location in bioark containing lat_longs for BBS stops w/in routes 
setwd("//bioark.ad.unc.edu/hurlbertlab/Databases/BBS/GPS_stoplocations")
