...
################################################################################*
#
# Dataset name: Breeding Bird Populations in forest plots at Robert Allerton Park
# Dataset source (link): https://www.ideals.illinois.edu/handle/2142/25182
# Formatted by: Sara Snell

#NOTE: dataset 300 is one of 4 datasets from Bird populations in East central
#IL: Fluctuations, variations, and development over a helf-century. Data from
#Appendix 3 of document
...
#NOTE: took average of two sites' acreage - 12.6 ha (upland) and 10.1 ha (floodplain)
...
#--! PROVIDE INFO !--#                                 
              'Number of male territories or pairs in each year provided.')
