...
#--! PROVIDE INFO !--#
bad_sp = c('Aeshnidae', 'Limnephilidae', 'Tipulidae', 'Simuliidae', 'Chrionomidae',
           'Oligochaeta', 'Ceratopogonidae', 'Perlodidae','Leptoceridae',
           ...
           'Taeniopterygidae', 'Tipulidae', 'Trichoptera','Viviparidae')
