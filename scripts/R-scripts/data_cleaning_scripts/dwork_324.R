################################################################################*
#
# Dataset name: Maryland Biological Stream Survey Benthis Macroinvertebrate data
# Dataset source (link): http://dnr2.maryland.gov/streams/Pages/mbss.aspx
#    Data accessed by contacting Michael Mishiwagi @ MD DNR
# Metadata here: http://dnr2.maryland.gov/streams/Publications/R4Manual.pdf
...
#--! PROVIDE INFO !--#
  'MBSS_BenthicTaxa1.xls, MBSS_BenthisTaxa2.xls') 
...
site_grain_names = c("msite","MDE6Name", "MDE8Name", "StreamName", "site")
...
# A total of 20 ft^2 sample, sampling available habitats proportionally over
# the 75 m stream transect over which fish are sampled
...
#--! PROVIDE INFO !--#                                 
              'Counts are number of individuals per 20ft2 sampling')
...
#--! PROVIDE INFO !--#
bad_sp = c('Aeshnidae', 'Limnephilidae', 'Tipulidae', 'Simuliidae', 'Chrionomidae','Chironominae',
           'CHIRONOMIDAE','Chironominae','Chironomini','Oligochaeta', 'Ceratopogonidae', 'Perlodidae','Leptoceridae',
           ...
           'Culicidae','Dixidae', 'Diptera','Dytiscidae', 'Elmidae', 'Empididae',
           'Ephemerellidae', 'Ephemeridae', 'Ephemeroptera', 'Gastropoda','Gerridae',
           'Glossiphoniidae','Glossosomatidae', 'Heptageniidae', 'Hirudinea','Hydrobiidae', 'Hydrophilidae',
           'Hydropsychidae', 'Hydroptilidae', 'Isopoda', 'Lymnaeidae', 'Nemouridae', 'Odonata', 'Orthocladiinae',
           'Orthocladiinae a', 'Orthocladiinae b','Philopotamidae','Phryganeidae','Pisidiidae','Planorbidae',
           'Plecoptera', 'Polycentropodidae','Psychodidae','Psychomyiidae','Stratiomyidae', 'Tabanidae',
           'Taeniopterygidae', 'Tipulidae', 'Trichoptera','Viviparidae','Cricotopus/Orthocladius')
...
#--! PROVIDE INFO !--#                                 
  "Taxa were organized in a convoluted way, so many species had their names changed or were removed. Created a taxa table for reference in preformatting script")
