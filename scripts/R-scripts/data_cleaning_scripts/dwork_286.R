...
################################################################################*
#
# Dataset name: Bromeliad invertebrate counts at different elevations in the LEF 
# Dataset source (link): http://luq.lternet.edu/data/luqmetadata131
...
dataset = read.table(paste('data/raw_datasets/dataset_', datasetID, '.csv', sep = ''), 
                     header=T, sep = ";")
...
#--! PROVIDE INFO !--#
  'BromelianInvertebrateSeriesData1993-97_2.csv') 
...
# TURNS OUT THERE ARE ONLY 4 TIME PERIODS IN THIS DATASET, SO INSUFFICIENT FOR OUR
# PURPOSES.
