...
################################################################################*
#
# Dataset name: monthly icthyoplankton data (1995-2000) collected from Yenliao Bay in 6 stations northeast of Taiwan
# Dataset source (link): personal communication
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('l', 'date', 'year')
...
#--! PROVIDE INFO !--#
    'The only modification to this field involved converting to a date object. Original data only had month/year info so added a "1" for as.date formatting')
...
#--! PROVIDE INFO !--#
  'The site field is the location of the station sampled.')
...
#--! PROVIDE INFO !--#
bad_sp = c('Engraulis japonicus(eggs)')
...
#--! PROVIDE INFO !--#
typo_name = c('Decapterus muroadsi')          

#--! PROVIDE INFO !--#
good_name = c('Decapterus maruadsi')
...
#--! PROVIDE INFO !--#                                 
  'Eggs were removed, and one typo was corrected.')
