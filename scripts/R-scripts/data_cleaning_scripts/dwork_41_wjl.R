################################################################################*
#  DATASET 41: Birds of Neotoma valley, OH
#
#  as reported in Preston 1960
#
#  Paper can be found at http://www.jstor.org/stable/1931793?origin=crossref&seq=9#page_scan_tab_contents 
...
# Change site name from "censusbreedingbirds_Neotoma" to "censusbreedingbirdsNeotoma" because the underscore causes problems later on

levels(site)[1] = 'censusbreedingbirdsNeotoma'
...
dataFormattingTable[,'Raw_siteUnit'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Raw_siteUnit','sampleID') 
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_siteFormat',  'no site information available here.  All sites are listed as censusbreedingbirds_Neotoma.  May need to get data again or re-check source.')
