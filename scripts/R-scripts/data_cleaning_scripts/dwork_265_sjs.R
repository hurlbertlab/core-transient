...
# Dataset source (link): 	http://www.sofnet.org/1020.0.1.0/274/download_24762.php
...
#--! PROVIDE INFO !--#
    'Only modification was converting to a date object.')
...
#--! PROVIDE INFO !--#
  'The site field is the number 1 because the study site was the same, and no grain size smaller than the area of the study site was provided ')
...
#--! PROVIDE INFO !--#                                 
              'Count data provided for each species by year')
...
#--! PROVIDE INFO !--#
typo_name = c('Regulus regules', 'T. troglodytes')           #no other genus begins with these letters

#--! PROVIDE INFO !--#
good_name = c('Regulus regulus', 'Troglodytes troglodytes')
...
#--! PROVIDE INFO !--#                                 
  'There were two species typos that were corrected, both were formatting typos.')
