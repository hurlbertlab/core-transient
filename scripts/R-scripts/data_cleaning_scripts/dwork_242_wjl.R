...
dataFormattingTable[,'Notes_countFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_countFormat', # Fill value below in quotes
                                 ...
                                 'Raw data are density per m2 in which adult and juvenile densities were separately recorded. These were added together and multiplied by 100 to get a count of the number of individuals in the 100 m2 survey area.')
