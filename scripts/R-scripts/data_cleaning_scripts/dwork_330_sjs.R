...
################################################################################*
#
# Dataset name: Central California Butterly Population Monitoring 
# Dataset source (link): http://butterfly.ucdavis.edu/ (actual data from personal communication)
...
#--! PROVIDE INFO !--#
  'The site field is the name of each site a transect was conducted.')
...
#--! PROVIDE INFO !--#
bad_sp = c('Hesperia colorado ssp.', 'Phyciodes campestris campestris/montana', 'Polites sabuleti ssp.', 'Speyeria callippe ssp.')
...
#--! PROVIDE INFO !--#                                 
  'There were a couple of species that were eliminated bc there were >50% with assigned subspecies, and there was one hybrid that was eliminated bc there were >50% of both parental lineages')
