...
# Dataset source (link): http://www.jstor.org/stable/pdf/2388268.pdf?acceptTC=true
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('FILENAME', 'STUDY', 'TIME', 'SEX.AGE', 'PERCH.SUBSTRATE', 'PERCH.DIAMETER', "COMMENTS", "WEIGHT", "SVL", "TAIL")
...
#--! PROVIDE INFO !--#
                                 155.5)  # calc as 22 (height) x pi*1.5^2
