...
################################################################################*
#
# Dataset name: Konza LTER small mammals
# Dataset source (link): http://www.konza.ksu.edu/knz/pages/data/KnzEntity.aspx?id=CSM011
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('DATACODE', 'RECTYPE')
...
site_grain_names = c("site","WATERSHED.LINE")
