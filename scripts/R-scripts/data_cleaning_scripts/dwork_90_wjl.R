################################################################################*
#  DATASET 90: Zooplankton in the Bay of Biscay
#  
...
# SampleID entries have three elements: 'Atlantic_Bay_of_Biscay', a site number, and the lat long coordinates. There are not enough sites per year for each site number, so only the lat/longs will be used. 

site = paste(word(dataset2$SampleID,6, sep = "_"), word(dataset2$SampleID,7, sep = "_"), sep = "_")
...
# Dataset has less than minNTime years per site, but they are lat/longs which will later be rounded so that they have enough years per site
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_siteFormat',  # Fill value below in quotes
                                 ...
                                 'site field heavily modified. site entries were originally entered as Atlantic_Bay_of_Biscay_sitenumber_lat_long. All info except lat_long was removed. ' )
...
dataFormattingTable[,'Notes_countFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_countFormat', # Fill value below in quotes
                                 ...
                                 'Data represents the presence of the species in an area. There were no NAs nor 0s that required removal')
...
# This is a reasonable choice of spatial grain because it most likely encompasses the community level of zooplankton

# sGrain = 2, number of unique sites is 2
# sGrain = 1, number of unique sites is 3
# sGrain = 0.5, number of unique sites is 5
# sGrain = 0.25, number of unique sites is 9
# sGrain = 0.1, number of unique sites is 13
