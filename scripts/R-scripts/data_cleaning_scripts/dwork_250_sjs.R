...
################################################################################*
#
# Dataset name: Stream fish assemblage stability in a southern Appalachian stream 
#at the Coweeta Hydrologic Laboratory from 1984 to 1995
# Dataset source (link): https://portal.lternet.edu/nis/mapbrowse?packageid=knb-lter-cwt.3047.13
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('record_id', 'standard_length_of_fish', 'weight', 'pass')
...
#--! PROVIDE INFO !--#
site_grain_names = c("creek_location")
...
#--! PROVIDE INFO !--#
  'The site field denotes a creek section')
...
#--! PROVIDE INFO !--#                                 
              'Each record reflects 1 individual, from which total counts are tallied.')
...
#--! PROVIDE INFO !--#                                 
  'Species were abbreviated and no bad species or typos were observed.')
