...
################################################################################*
#
# Dataset name: Lake Kasumigaura database, Table 15-2 Fish density data
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('geodeticDatum', 'infraspecificEpithet')
...
#--! PROVIDE INFO !--#
site_grain_names = c("decimalLatitude", "decimalLongitude")
...
#--! PROVIDE INFO !--#
                                 'm') # 2 types of nets - went  w the smaller bc there was more description
...
#### MERGE GENUS AND SPP FIELDS
dataset5 = unite(dataset5, spp, genus, specificEpithet)
#--! PROVIDE INFO !--#
speciesField = 'spp'
...
#--! PROVIDE INFO !--#                                 
  'Only bad spp was a blank entry')
...
#--! PROVIDE INFO !--#
# Lat longs were only site info provided
