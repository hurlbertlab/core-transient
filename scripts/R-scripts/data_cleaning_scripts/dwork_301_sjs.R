...
################################################################################*
#
# Dataset name: Breeding Bird Populations in abandoned farmland 40 ha plots at Robert Allerton Park
# Dataset source (link): https://www.ideals.illinois.edu/handle/2142/25182
# Formatted by: Sara Snell

#NOTE: dataset 301 is one of 4 datasets from Bird populations in East central
#IL: Fluctuations, variations, and development over a helf-century. Data from
#Appendix 4 of document
...
#--! PROVIDE INFO !--#
  'The site field consists of the number 1 because all birds were observed on abandoned farmland plot in Robert Allerton Park (40 ha).')
...
#--! PROVIDE INFO !--#                                 
              'Number of pairs in each year provided.')
...
#--! PROVIDE INFO !--#
# only study site of 24 ha was used
