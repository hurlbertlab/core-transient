...
################################################################################*
#
# Dataset name: Long-Term Nitrogen Deposition: Population, Community, and Ecosystem Consequences - Experiment 001
# Dataset source (link): https://www.cedarcreek.umn.edu/research/data/dataset?ple001
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('recordid', 'ntrt', 'nadd', 'nitradd', 'natm.nadd')
...
#--! PROVIDE INFO !--#
#####ADDED IN subset to fields A-C bc D was sampled at a diff scale
dataset2 <- dataset2[ which(dataset2$field != 'D'), ] 
...
#--! PROVIDE INFO !--#                                 
              'Biomass data provided ranging from 0-8000')
