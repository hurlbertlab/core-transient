...
################################################################################*
#
# Dataset name:DYNAMICS AND ORGANIZATION OF A ROCKY INTERTIDAL
#           FISH ASSEMBLAGE: THE PERSISTENCE AND RESILIENCE
#             OF TAXOCENE STRUCTURE
# Dataset source (link): http://www.jstor.org/stable/2461182
...
#--! PROVIDE INFO !--#
  'The site field is the number 1 because there is only one study site.')
...
#--! PROVIDE INFO !--#                                 
  'No typos or bad species were found.')
