################################################################################*
#  DATASET 87: Phytoplankton in Netherlands
#
...
# Only two sites: 'Oosterschelde_Netherlands_51.4926_4.1275' and 'Oosterschelde_Netherlands_51.6059_3.6966'
# Only relevant data is lat/long, substring to only include those

table(dataset2$SampleID)

dataset2$SampleID = str_sub(dataset2$SampleID, -14)
...
# Each lat/long combo has more than 6 years, looks good
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_siteFormat',  # Fill value below in quotes
                                 ...
                                 'Only two different sites in this dataset.  Lat_longs were extracted from the strings using substring because it was the only useful data.')
...
# This is a reasonable choice of spatial grain because the lat/longs of the two sites are very close: 51.4926_4.1275 and 51.6059_3.6966
