...
################################################################################*
#
# Dataset name: Vegetation surveys in large-herbivore exclusion in an African savanna: five years of the UHURU experiment
# Dataset source (link): http://www.esapubs.org/archive/ecol/E095/064/metadata.php
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('BARE_GROUND')
...
dataset2$SITE[dataset2$SITE == "Central"] = "CENTRAL" 
...
#--! PROVIDE INFO !--#
                                 1) #a series of three herbivory treatments and a control were randomly assigned to contiguous 1-ha plots replicated three times at each of three sites along a rainfall gradient (36 total plots).
...
#--! PROVIDE INFO !--#                                 
              'Presence data provided, 1s indicate presence')
...
#--! PROVIDE INFO !--#
bad_sp = c('Aristida_lumped', 'Barleria_2', 'Barleria_3', 'Eragrostis_spp',
           'Hibiscus_2','Ipomoea_2','Ipomoea_3', 'Justicia_lumped', 'Portulaca_spp',
           'Solanum_big', 'Sporobolus_spp', 'Unknown', 'unknown_30','unknown_4', 'unknown_B',
           'unknown_B3', 'unknown_B4','unknown_B5','unknown_B8','unknown_BB','unknown_F','unknown_S',
           'unknown_S7','unknown3B', 'unknown5','unknown6', 'unknown7','unknownS3')
...
#--! PROVIDE INFO !--#
typo_name = c('Euphorbia_big', 'Euphorbia_crotonoides', 'Euphorbia_inaequilatera',
              'Euphorbia_rare', 'Euphorbia_spp_small','Indigofera_big','Indigofera_lumped',
              'Indigofera_small', 'Phylanthus_sp', 'Plectranthus_big', 'Plectranthus_small')           

#--! PROVIDE INFO !--#
good_name = c('Euphorbia','Euphorbia','Euphorbia','Euphorbia','Euphorbia','Indigofera',
              'Indigofera','Indigofera', 'Phylanthus', 'Plectranthus', 'Plectranthus')
...
#--! PROVIDE INFO !--#                                 
  'They switched back and forth between scienfitic and common names so it was hard to distinguish, but tried to keep naming conventions similar and removed all unknowns.')
