################################################################################*
#
# Dataset name: A Long-Term Bird Population Study in an Appalachian Spruce Forest
# Dataset source (link): http://www.jstor.org/stable/4161914
# Formatted by: Sara Snell
#
# NOTE: Tables 3 & 4, singing male numbers determined by the index method, 1962-1983
#-------------------------------------------------------------------------------*
# ---- SET-UP ----
#===============================================================================*
...
#--! PROVIDE INFO !--#
  'extracted from Hall 1984 Wilson Bulletin') 
...
#--! PROVIDE INFO !--#
###ADDED IN: only 1 site so numbered "1"
dataset2$site = 1
...
#--! PROVIDE INFO !--#
  'The study area is a single plot.')
...
#--! PROVIDE INFO !--#
typo_name = c('Black0capped Chickadee', 'Black0throated Blue Warbler', 
              'Black0throated Green Warbler', 'Blackbumian Warbler', 'Chestnut0sided Warbler', 
              'Dark0eyed Junco', 'Golden0crowned Kinglet', 'Rufous0sided Towhee',
              'Yellow0rumped Warbler')           

#--! PROVIDE INFO !--#
good_name = c('Black-capped Chickadee', 'Black-throated  Blue Warbler', 
              'Black-throated Green Warbler', 'Blackburnian Warbler', 'Chestnut-sided Warbler',
              'Dark-eyed Junco', 'Golden-crowned Kinglet', 'Rufous-sided Towhee',
...
#--! PROVIDE INFO !--#                                 
  'A number of names had 0s instead of dashed so they were corrected. One species had a rn/m typo.')
