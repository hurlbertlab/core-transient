################################################################################*
#
# Dataset name: Species Turnover Rates on Islands: Dependence on Census Interval
# Dataset source (link): http://www.jstor.org/stable/1744518?seq=1#page_scan_tab_contents
...
#--! PROVIDE INFO !--#
  'extracted from Diamond and May 1977') 
...
#--! PROVIDE INFO !--#
  'The site field is the number one beacuse the study did not specify which island each bird was found on.')
...
#--! PROVIDE INFO !--#                                 
              'Count data provided for each year of species found on the Farne islands')
...
#--! PROVIDE INFO !--#                                 
  'S* was the total number of species dound each year so it was removed.')
