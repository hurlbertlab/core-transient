...
################################################################################*
#
# Dataset name: Antarctica seabird census
# Dataset source (link): https://portal.lternet.edu/nis/mapbrowse?packageid=knb-lter-pal.100.1
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('CountMinute', 'Linkages', 'Behavior', 'Direction', 'Notes')
...
#--! PROVIDE INFO !--#
site_grain_names = c("studyName", "CruiseName")
