################################################################################*
#  DATASET 70: GPDD Butterflies of Belgium
#
#  Metadata can be found at http://www3.imperial.ac.uk/cpb/databases/gpdd
#  ^ Requires login ^

# Some background can be viewed at the out-of-date project website here:
# https://web.archive.org/web/19990220041409/http://users.skynet.be/bs663526/
...
# In this case, the dataset seems to pertain to all of Belgium
...
# Only site has 14 years, looks good 
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_siteFormat',  # Fill value below in quotes
                                 ...
                                 'data includes only one site: Belgium. No changes made')
...
dataFormattingTable[,'Notes_spFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_spFormat',    # Fill value below in quotes
                                 ...
                                 'all species good, none removed from data')
