...
################################################################################*
#
# Dataset name:Long-term monitoring of Mammals in the face of biotic and abiotic influences at a semiarid site in north-central Chile. Shrubs and herbaceous plants.
...
#--! PROVIDE INFO !--#
  'Fray_Jorge_Small_Mammals_198903-200512.csv') 
...
#--! PROVIDE INFO !--#
    'Date was converted from Julian day to Y-M-D using the origin date, 9-01-1988.')
...
#--! PROVIDE INFO !--#                                 
  'No alterations to species name were necessary since there were only a few names and
they were represented wwith two letters. Data in presence/absence format.')
...
#--! PROVIDE INFO !--#
# There is only grid data provided divided up by rows and columns.
