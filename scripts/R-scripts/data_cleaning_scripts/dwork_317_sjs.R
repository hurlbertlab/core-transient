...
################################################################################*
#
# Dataset name: Karoo National Park Census Data
# Dataset source (link): http://datak np.sanparks. org/sanparks /metacat/pe ggym.117.10 /sanparks
...
#--! PROVIDE INFO !--#
  'peggym.115.1-KRNPCensusdata.txt') 
...
#--! PROVIDE INFO !--#
site_grain_names = c("Transect","Block...Stratum")
