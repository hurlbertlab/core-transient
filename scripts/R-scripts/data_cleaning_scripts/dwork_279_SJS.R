...
################################################################################*
#
# Dataset name:North Temperate Lakes LTER: Zooplankton - Madison Lakes Area 1997 - current
# Dataset source (link):https://lter.limnology.wisc.edu/dataset/north-temperate-lakes-lter-zooplankton-madison-lakes-area-1997-current
...
#--! PROVIDE INFO !--#
site_grain_names = c("lakeid", "station", "towdepth")
...
#--! PROVIDE INFO !--#
countfield = "individuals_measured"
...
dataFormattingTable[,'Notes_countFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_countFormat', 
                                 ...
                                 #--! PROVIDE INFO !--#                                 
                                 'count data provided for number of individuals measured')
