...
# Only one site in this dataset, and no information about sites available
# Only says "time_transect"; might need to get data info or new data from this
# source
...
dataFormattingTable[,'Raw_siteUnit'] = 
  dataFormattingTableFieldUpdate(ds, 'Raw_siteUnit','time_transect') 
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(ds, 'Notes_siteFormat',  'no site information available here.  All sites are listed as time_transect.  May need to get data again or re-check source.')
...
write.csv(dataset7, "data/formatted_datasets/dataset_39.csv", row.names = F)
