################################################################################*
#  DATASET 173: Pacific and Indian Ocean Marine Life (JAMSTEC)
#
...
# Site entries look like "Ocean_region_sitenumber" but they often have underscores within the site elements, e.g. South_Western_Pacific_Brothers_Seamount_1334

# Site entries are inconsistent in length, some don't have ocean or sitenumber. Site formatting might have to go on a case-by-case basis? 
# Might be able to find lat/longs
