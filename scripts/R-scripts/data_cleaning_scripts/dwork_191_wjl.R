################################################################################*
#  DATASET 191: East Coast Benthos (NEFSC)
#
...
# Site entries look like "USA_NA_0.1_m^2___40.1_-72.667"
# Only the lat/longs are important, they will be extracted
...
# Dataset has less than minNTime years per site but they are lat/longs, so they can be rounded later to generate occupancy data 
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_siteFormat',  # Fill value below in quotes
                                 ...
                                 #####
                                 'the site entries looked like "USA_NA_0.1_m^2___40.1_-72.667", only the lat/longs at the end were extracted')
