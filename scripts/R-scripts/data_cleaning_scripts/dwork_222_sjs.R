...
# Dataset source (link): http://esapubs.org/archive/ecol/E091/243/default.htm#data
...
#--! PROVIDE INFO !--#
bad_sp = c('unknown', 'unknown grass', 'unknown lichen', 'unknown moss')
