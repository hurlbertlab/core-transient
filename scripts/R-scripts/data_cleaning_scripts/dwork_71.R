...
################################################################################*
#
# Dataset name: Phytoplankton from the White Sea, Barents Sea, Norwegian Sea and Arctic Basin, 1993-2003
# Dataset source (link): http://www.arcodiv.org/Database/Plankton_datasets.html
# Dataset also available from iOBIS.org (OBIS Resource ID 1559)
...
#--! PROVIDE INFO !--#
  '5722656aba038_20160428_213406.csv') 
...
#--! PROVIDE INFO !--#
dateFieldName = c('yearcollected', 'monthcollected', 'daycollected')
...
#--! PROVIDE INFO !--#
    'Year, month and day fields combined.')
...
#--! PROVIDE INFO !--#
dataset2$latlong = paste(dataset2$latitude, "_", dataset2$longitude, sep = "")
site_grain_names = c("locality", "latlong")
...
# What is the spatial grain of the finest sampling scale? Currently unknown
# without more specific metadata
...
#--! PROVIDE INFO !--#
  'Sampling locations are designated by lat-long, but these are nested within geographically defined regions.')
...
#--! PROVIDE INFO !--#
countfield = "observedindividualcount"
...
#--! PROVIDE INFO !--#                                 
              'Density estimated from microscope counts.')
...
#--! PROVIDE INFO !--#
bad_sp = c('Entomoneis', #3 recs compared to ~80 identified to species
           'Eutreptiella', #24 recs compared to >400 identified to species
           'Melosira') #5 recs compared to 24 identified to species
...
#--! PROVIDE INFO !--#
typo_name = c('Bicosoeca gracilipes',
              'Euglena acusformis',
              'Eutreptia lanowii',
              'Glenodinium pilula',
...
#--! PROVIDE INFO !--#                                 
  '3 unid taxa were removed, and several other taxa were lumped with the genus or higher taxon')
...
# ... it aggregates over multiple spatial samples within a geographically defined area.
# ... note however, that one could alternatively choose to use lat-long blocks.
