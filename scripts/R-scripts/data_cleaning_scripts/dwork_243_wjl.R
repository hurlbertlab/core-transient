...
dataFormattingTable[,'Raw_datafile_name'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Raw_datafile_name',  
                                 ...
                                 #--! PROVIDE INFO !--#
                                 'Midwater fish density raw data.csv') 
...
dataFormattingTable[,'Notes_countFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_countFormat', # Fill value below in quotes
                                 ...
                                 'Raw data represents density per m2, and adult and juvenile densities were in separate columns. These were added together in count column and multiplied by 250 to get count of individuals in 50 x 5 m transect.')
...
# These could refer to any of the 11 species of Sebastes found in the study.
...
# The codes 1006 and 1008 are the female and male entries for Semicossyphus pulcher. These can be combined, as we are only looking at species, not sex.
# The code 1006 now represents all individuals of species Semicossyphus pulcher

dataset6$species[dataset6$species == '1008'] = '1006'
