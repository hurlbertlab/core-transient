...
################################################################################*
#
# Dataset name: Small-mammal responses to large-herbivore exclusion in an African savanna: five years of the UHURU experiment
# Dataset source (link): http://www.esapubs.org/archive/ecol/E095/064/#data
