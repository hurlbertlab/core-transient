...
################################################################################*
#
# Dataset name: Lake Kasumigaura database, Table 14-1 Benthos data
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('Total', 'Flag', 'X')
...
#--! PROVIDE INFO !--#                                 
              'density (number/m2) provided for benthos')
...
#--! PROVIDE INFO !--#
typo_name = c('Polypedilum.sp.p..', 'Tanytarsini.gen..sp.')           

#--! PROVIDE INFO !--#
good_name = c('Polypedilum.spp.', 'Tanytarsini.spp.')
...
#--! PROVIDE INFO !--#                                 
  'Typos fixed, only bad spp was unknown classification')
...
#--! PROVIDE INFO !--#
# There was only spatial grain available, and it was the volume of sample taken at each station
