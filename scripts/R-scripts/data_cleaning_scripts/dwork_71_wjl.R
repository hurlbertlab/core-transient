################################################################################*
#  DATASET 71: ArcOD Phytoplankton from the White Sea, Barents Sea, Norwegian Sea and Arctic Basin
#
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_siteFormat',  # Fill value below in quotes
                                 ...
                                 'Sites have a lot of unnecessary information including species names, catch methods, etc. No changes made to site data, need to find way to remove some unwanted info from sites')
...
# Removing ENTOMONEIS because there are many other entries that are more specific. Entries with just the genus could be one of the 6 species, but was not identified sufficiently.
...
typo_name = c(' CHAETOCEROS_INGOLFIANUS',
              ' EUGLENA_ACUSFORMIS',
              ' TH+M37663ALASSIOSIRA_ANTARCTICA_BOREALIS')

good_name = c(' CHAETOCEROS_INGOLFIANUM',
              ' EUGLENA',
              ' THALASSIOSIRA_ANTARCTICA_BOREALIS')
...
dataFormattingTable[,'Notes_spFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_spFormat',    # Fill value below in quotes
                                 ...
                                 'several entries were removed or changed because they were only identified to the genus, with other entries of that genus being identified to the species. This means that those entries could possibly fall under the other identified species entries. One typo was found and changed:  TH+M37663ALASSIOSIRA_ANTARCTICA_BOREALIS')
