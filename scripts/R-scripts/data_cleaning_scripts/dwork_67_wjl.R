################################################################################*
#  DATASET 67: South African Waterbirds 
#
...
# Change the name of the "Species" column to "species":
...
dataFormattingTable[,'Notes_timeFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_timeFormat', 'temporal data provided yearly. only change made was to a numeric object.')

# subannualTgrain. After exploring the time data, was this dataset sampled at a sub-annual temporal grain? Y/N

dataFormattingTable[,'subannualTgrain'] = 
  dataFormattingTableFieldUpdate(datasetID, 'subannualTgrain', 'N')
...
# For this dataset spatial grain varies considerably and we don't have the means currently to extract it.
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_siteFormat',  # Fill value below in quotes
                                 ...
                                 'Sites are listed as lat_long, but each lat_long corresponds to a specific wetland. Thus we are NOT treating this like a lat-long dataset that could be spatially aggregated.')
...
dataFormattingTable[,'Notes_countFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_countFormat', 
                                 ...
                                 "Count data are suspected to be sums of binary presence data across surveys within any one year. They should not be relied on for estimates of abundance or mean abundance.")
...
# Many species names were cut off in the original dataset.

typo_name = 'PHALACROCORAX_NEGLECT'
good_name = 'PHALACROCORAX_NEGLECTUS'

typo_name[2] = 'PACHYPTILA_CRASSIROST'
good_name[2] = 'PACHYPTILA_CRASSIROSTRIS'

typo_name[3] = 'PELECANOIDES_GEORGICU'
good_name[3] = 'PELECANOIDES_GEORGICUS'

typo_name[4] = 'PELECANOIDES_URINATRI'
good_name[4] = 'PELECANOIDES_URINATRIX'

typo_name[5] = 'PHALACROCORAX_ATRICEP'
good_name[5] = 'PHALACROCORAX_ATRICEPS'

typo_name[6] = 'PHALACROCORAX_CAMPBEL'
good_name[6] = 'PHALACROCORAX_CAMPBELLI'

typo_name[7] = 'PHALACROCORAX_CORONAT'
good_name[7] = 'PHALACROCORAX_CORONATUS'

typo_name[8] = 'PROCELLARIA_AEQUINOCT'
good_name[8] = 'PROCELLARIA_AEQUINOCTIALIS'

typo_name[9] = 'PTERODROMA_ARMINJONIA'
good_name[9] = 'PTERODROMA_ARMINJONIANA'

typo_name[10] = 'PTERODROMA_INEXPECTAT'
good_name[10] = 'PTERODROMA_INEXPECTATA'

typo_name[11] = 'STERCORARIUS_PARASITI'
good_name[11] = 'STERCORARIUS_PARASITICUS'

typo_name[12] = 'STERCORARIUS_POMARINU'
good_name[12] = 'STERCORARIUS_POMARINUS'

typo_name[13] = 'THALASSARCHE_MELANOPH'
good_name[13] = 'THALASSARCHE_MELANOPHRIS'

typo_name[14] = 'CHLIDONIAS_LEUCOPTERU'
good_name[14] = 'CHLIDONIAS_LEUCOPTERUS'
...
dataFormattingTable[,'Notes_spFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_spFormat',    # Fill value below in quotes
                                 ...
                                 'Removed several species entries because they did not reference recognizable species: LESSER-CRESTED_X_SAND and KERMADEC_X_ROUND_ISLA. There were many entries that were cut off in the original dataset. These were renamed to their full names. For example: PACHYPTILA_CRASSIROST was replaced with PACHYPTILA_CRASSIROSTRIS')
...
# ...each wetland was assumed to be of a scale relevant for observation. 
