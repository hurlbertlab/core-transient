...
################################################################################*
#
# Dataset name: One hundred and six years of population and community dynamics of 
# Sonoran Desert Laboratory perennials. Ecology 94:976. http://dx.doi.org/10.1890/12-1164.1
# Dataset source (link): http://esapubs.org/archive/ecol/E094/083/
...
#--! PROVIDE INFO !--#
  'desertlabshrub.txt') ###NOTE: data acquired from rare data stabilization repo 
...
#--! PROVIDE INFO !--#
                                 'm2') # avg amount - ranged from 90-110 m
...
#--! PROVIDE INFO !--#
  'The site field describes the habitat type the plants were found at - open or shrub.')
