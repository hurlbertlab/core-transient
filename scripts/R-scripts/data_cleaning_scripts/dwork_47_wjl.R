################################################################################*
#  DATASET 47: Waterfowl in Redvers study area
#  
#  Metadata can be found at http://ecologicaldata.org/wiki/redvers-waterfowl-census
#
#  See also Vickery & Nudds 1984 Ecology 65: 96-104
...
# Change the name of the "SampleID" column to simply "date":

names(dataset1)[1] = 'date'

# Change the name of "Species" to "species"
...
dataFormattingTable[,'Notes_timeFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_timeFormat','data provided as years. only modification to this field was converting to numeric object.')
...
site = str_sub(site, start = 2, end = -7)
unique(site)

# What is the spatial grain of the finest sampling scale? 

# According to Vickery & Nudds 1984, Lousana Study Area is 0.2 x 55 km, while
# Redvers Study Area is 0.2 x 64.4 km, yielding an average of 11.94 km2
...
datasetYearTest = data.frame(site, dateYear)

ddply(datasetYearTest, .(site), summarise, 
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_siteFormat',  'site data included two sites followed by year: Redvers_year and Lousana_year.  Used substring to remove the year from the site leaving just the site in the data.')
...
dataFormattingTable[,'countFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'countFormat', 'count')

dataFormattingTable[,'Notes_countFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_countFormat', "Data represents abundance counts. no changes or removals necessary")
...
dataFormattingTable[,'Notes_spFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_spFormat', "all species good, none removed from data")
#-------------------------------------------------------------------------------*
...
# As we've now successfully created the formatted dataset, we will now update the format format flag field. 
