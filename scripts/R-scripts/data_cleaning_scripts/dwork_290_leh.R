...
#--! PROVIDE INFO !--#
unusedFieldNames = c('DATACODE', 'ENTITY', 'DISTRICT', 'TRANS','LIFEFORM','OCCURRENCE','HEIGHT1','TREESEED1','HEIGHT2','TREESEED2','HEIGHT3','TREESEED3','HEIGHT4','TREESEED4','HEIGHT5','TREESEED5','HEIGHT6','TREESEED6','PTYPE','PERSONNEL')
...
dataset1$cover = apply(dataset1[, 6:11], 1, function(x) {x[is.na(x)] = 0; mean(x, na.rm=T)})
