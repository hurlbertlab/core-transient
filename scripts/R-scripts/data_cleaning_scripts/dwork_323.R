################################################################################*
#
# Dataset name: Maryland Biological Stream Survey Fish data
...
# Dataset notes: Rare, Threatened, and Endangered (RTE) taxa are included in this
#                dataset but with their species names removed and replaced with,
#                for example, "RTE Taxa 1", "RTE Taxa 2", and so on.

#                Note that these RTE taxa will not be included by the provider
...
# 75 m stream section, of variable width. We'll say 6 m wide on average
