...
################################################################################*
#
# Dataset name: North Temperate Lakes LTER: Phytoplankton - Madison Lakes Area 1995 - current
# Dataset source (link):https://lter.limnology.wisc.edu/dataset/north-temperate-lakes-lter-phytoplankton-madison-lakes-area-1995-current
...
#--! PROVIDE INFO !--#
  'North_Temperate_Lakes_LTER:_Phytoplankton_Madison_Lakes_Area_1995_current.csv') 
...
#--! PROVIDE INFO !--#
# There is only 1 station number per lake, and many entries have no station number."
