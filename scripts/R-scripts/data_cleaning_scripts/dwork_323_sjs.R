...
################################################################################*
#
# Dataset name: Annual size measurements of a subset of tagged and mapped trees within each plot: UHURU experiment
...
#--! PROVIDE INFO !--#
unusedFieldNames = c('ORIGINAL_TAG', 'NEW_TAG', 'DEAD', 'HEIGHT', 'AXIS_1',
                     'AXIS_2', 'CIRC', 'MEASUREMENT', 'STEMS')
...
site_grain_names = c("SITE","PLOT") #PLOT comprises level, block, and treatment
...
#--! PROVIDE INFO !--#
  'The site field is a concatenation of site and plot.')
...
#--! PROVIDE INFO !--#                                 
              'No count data provided, 1s added to indicate presence')
