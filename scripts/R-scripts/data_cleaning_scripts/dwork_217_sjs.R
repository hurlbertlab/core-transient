...
#--! PROVIDE INFO !--#
unusedFieldNames = c('X', 'RECTYPE', 'SOILTYPE', 'SPECODE', 'Pid')
...
#--! PROVIDE INFO !--#
    'The only modification to this field involved converting to a date object. Formatted date in preformatting script.')
...
#--! PROVIDE INFO !--#
bad_sp = c('carex spp.','cyperu spp.', 'euphor spp.', 'symphy spp.')
