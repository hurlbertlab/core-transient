################################################################################*
#  DATASET 92: White Sea Benthos
#
# Metadata can be found at http://www.vliz.be/en/imis?module=dataset&dasid=2769
...
# The site entries looks like 'Russia_WhiteSea_sitenumber_lat_long' but there are many that do not have the site number. Only the lat/long can be used, so everything else will be removed.

site = paste(word(site,5,sep="_"),word(site,4,sep="_"),sep="_")
...
# Dataset has less than minNTime years per site because they are lat/longs, but they will be rounded later. 
...
dataFormattingTable[,'Notes_siteFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_siteFormat',  # Fill value below in quotes
                                 ...
                                 'site entries originally looked like Russia_WhiteSea_98_33.97_66.41, but they were cut down to just include lat/longs')
...
dataFormattingTable[,'Notes_spFormat'] = 
  dataFormattingTableFieldUpdate(datasetID, 'Notes_spFormat',    # Fill value below in quotes
                                 ...
                                 'No species removed. No chnages made to species column')
...
# This is a reasonable choice of spatial grain because it yields 3 sites of an appropriate size that demonstrate the size of benthic communities.
